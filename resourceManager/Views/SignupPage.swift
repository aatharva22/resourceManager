...
struct SignupPage: View {
    ...
    var body: some View {
            ...
            VStack(spacing: 20) {
                ...
                Text(signupResult).font(.subheadline).foregroundColor(.red)
    ...
    func signUp() {
        ...
        let res = bookingManager.signUp(userName: userName, password: password)
        if res {
            ...
            signupResult = "User already exists, please try a different username."
...
#Preview {
    ...
    SignupPage(bookingManager: manager, isLoggedIn: .constant(false))
